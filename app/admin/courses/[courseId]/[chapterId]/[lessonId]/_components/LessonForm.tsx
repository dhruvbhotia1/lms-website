...
import { AdminLessonType } from "@/lib/lessons/admin-get-lesson"
...
import { lessonConfigure } from "@/lib/lessons/lesson-configure"
...
export function LessonForm({ data, chapterId, courseId }: Props) {
  ...
  return (
    ...
    <div>
      <Link href={`/admin/courses/${courseId}/edit`} className={buttonVariants({variant: "outline", size: "sm", className: "mb-6"})}>
