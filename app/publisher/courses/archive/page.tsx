...
import { publisherGetArchivedCourses } from "@/lib/courses/publisher/publisher-get-archived-courses";
...
export default function ArchiveCoursePage() {

    return (
        <>
            <div className={"flex items-center justify-between"}>
                <h1 className={"text-2xl font-bold"}>Your archived courses</h1>
            ...
            <Suspense fallback={ <PublisherCourseCardSkeletonLayout/> }>
                <RenderArchiveCourses/>
            </Suspense>
        </>
    );
}

async function RenderArchiveCourses() {

    const data = await publisherGetArchivedCourses();
