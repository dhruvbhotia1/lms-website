        ...
        <Card className={"gap-y-6"}>
            ...
            <CardContent>
                ...
                <div className={"flex flex-col gap-y-6"}>
                    <Button className={"text-sm w-full gap-x-4"} onClick={handleGithubSignUp}>
                        <FaGithub className={"size-4"}/>
                        Sign in with Github
                    </Button>

                    <Button className={"text-sm w-full gap-x-4"} onClick={handleGoogleSignUp}>
                ...
                <div className={"grid gap-6"}>
                    ...
                    <div className={"grid gap-y-6"}>
                        ...
                        <div className={"grid gap-y-3"}>
                            ...
                            <Input type={"name"} placeholder={"Enter your full name"} value={name} onChange={(e) => setName(e.target.value)}/>
                        </div>
