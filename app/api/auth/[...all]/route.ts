...
async function protect(req: NextRequest): Promise<ArcjetDecision> {
    ...
    if (req.nextUrl.pathname.startsWith("/api/auth/sign-up")) {
        // Better-Auth reads the body, so we need to clone the request preemptively// The arcjet instance is created outside of the handler
        ...
        if (typeof body.email === "string") {
            ...
            return aj
                .withRule(detectBot(botOptions))// The arcjet instance is created outside of the handler
