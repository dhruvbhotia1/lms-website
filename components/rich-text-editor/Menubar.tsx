...
import {Bold, Heading1, Heading2, Heading3, Italic, ListIcon, ListOrdered, Strikethrough, UndoIcon} from "lucide-react";
...
export function Menubar({editor}: Props) {
    ...
    return(
        ...
        <div className={"flex border border-input border-t-0 border-x-0 rounded-t-lg p-2 bg-card flex-wrap gap-1 items-center"}>
